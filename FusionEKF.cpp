...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
    // TODO: Radar updates
    Tools tools;  // uisng tools.cpp to calculate Jacobian
    Hj_ = tools.CalculateJacobian(ekf_.x_);
    ekf_.H_ = Hj_;     // the H we are using here ends up being the calculated Jacobian Hj of the extended kalman filter state vector
